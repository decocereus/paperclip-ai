export const queryKeys = {
  ...
  issues: {
    ...
    runtimeLink: (issueId: string) => ["issues", "runtime-link", issueId] as const,
    conversation: (issueId: string) => ["issues", "conversation", issueId] as const,
  ...
  instance: {
    ...
    runtimeSources: ["instance", "runtime-sources"] as const,
    runtimeSourcesDiscovery: ["instance", "runtime-sources-discovery"] as const,
    runtimeSourcesCodexThreads: ["instance", "runtime-sources-codex-threads"] as const,
    runtimeSourcesCodexSkills: ["instance", "runtime-sources-codex-skills"] as const,
